...
module.exports = "<!DOCTYPE html>\n<html>\n<head>\n\t<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />\n    <script src='https://www.google.com/recaptcha/api.js'></script>\n</head>\n\n<body class=\"background-black\">\n<nav>\n        <a routerLink=\"/signup\" routerLinkActive=\"active\" class=\"button_layout\">Sign Up</a>\n        <a routerLink=\"/login\" routerLinkActive=\"active\" class=\"button_layout\">Log In</a>\n</nav>\n       \n</body>\n<router-outlet></router-outlet>\n</html>\n"
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.postData = function (user) {
...
module.exports = "<form id=\"login\">\n    <h1>Регистрация</h1>\n    <fieldset id=\"inputs\">\n        <input id=\"username\" type=\"text\" placeholder=\"Логин\" autofocus required>\n        <input id=\"email\" type=\"email\" placeholder=\"Почта\" required>   \n        <input id=\"password\" type=\"password\" placeholder=\"Пароль\" required>\n        <input id=\"password_copy\" type=\"password\" placeholder=\"Повторите пароль\" required>\n    </fieldset>\n    <fieldset id=\"actions\" style=\"display: flex; text-align: -webkit-center;\">\n            <re-captcha (resolved)=\"resolved($event)\" siteKey=\"6Lf0_CoUAAAAAKibE4lxIMuLsDNnNOwHpnN8MsbK\"></re-captcha>\n        <input type=\"submit\" id=\"submit\" (click)=\"signUpButton();\" value=\"Зарегистрироваться\" style=\"margin-top: 7px;\">\n        <div>\n        <p [hidden]=\"!(recaptchaIsCompleted && buttonWasPressed || !recaptchaIsCompleted && buttonWasPressed)\">Вы не прошли качу! Может быть, вы - робот? Задумайтесь...</p>\n        </div>\n    </fieldset>\n    <script src='https://www.google.com/recaptcha/api.js'></script>\n</form>"
...
var SignupComponent = /** @class */ (function () {
    function SignupComponent(httpService) {
        ...
        this.recaptchaIsCompleted = false;
        this.buttonWasPressed = false;
        this.userPostModel = { Email: "example", Password: "example", ConfirmPassword: "example" };
    }
    SignupComponent.prototype.ngOnInit = function () {
    };
    SignupComponent.prototype.resolved = function (captchaResponse) {
        if (captchaResponse != null) {
            jquery__WEBPACK_IMPORTED_MODULE_2__("#submit").css('background', '#ffb94b');
            this.recaptchaIsCompleted = true;
        }
    };
    SignupComponent.prototype.signUpButton = function () {
        this.buttonWasPressed = true;
        if (!this.recaptchaIsCompleted) {
            jquery__WEBPACK_IMPORTED_MODULE_2__('#login').css('height', '450px');
            return;
        }
        this.submit();
    };
    SignupComponent.prototype.submit = function () {
        this.httpService.postData(this.userPostModel)
            .subscribe(function (data) { console.log("hell yeah!!!"); }, function (error) { return console.log(error); });
    };
...
module.exports = __webpack_require__(/*! C:\Users\Nick\source\repos\ToDoProject\ToDoProject.WebUI\app\src\main.ts */"./src/main.ts");
